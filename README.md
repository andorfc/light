...
| Folder | Contents |
|---|---|
| [`figures/`](figures) | All QC and DE figures (PNG) |
| [`matrices/`](matrices) | Expression matrices, normalized counts, VST, PCA, correlation, mapping summary |
...
### Expression matrices ([`matrices/`](matrices))
